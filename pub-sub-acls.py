...
for message in consumer:
    print ("Received Message from Kafka Server:" + message.value) + "\n"
    ...
    if "ACL_file_updated" in message.value:
        ...
        fetch_page.setopt(fetch_page.URL, 'http://192.168.7.29/CA_Security_ACL_list_2017')
        ...
        ACL_to_apply = []
        common_keys = set(fetched_acls_nested.keys()) & set(local_acl_nested.keys())
